...
| **FlowCraft**                    |                                            **75.75** J% | `--soft-merge=false`, `--answer-llm=azure_4o_mini --judge-llm=azure_4o_mini` | run [25896493084](https://github.com/GizClaw/flowcraft/actions/runs/25896493084) (May 15, 2026); n=1542 questions on LoCoMo10; em=30.35, f1=18.32; episodic guard then committed to SDK so default soft_merge no longer regresses episodic-heavy data |
