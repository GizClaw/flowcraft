...
func main() {
	in := flag.String("in", "eval/locomo/data/locomo/data/locomo10.json", "path to upstream locomo10.json")
	out := flag.String("out", "eval/locomo/data/locomo10.jsonl", "path to write .jsonl dataset")
