...
// messages. Higher-level behaviors such as extraction, summarization, recall
// projections, and worker lifecycle orchestration are built on top of this
// evidence source by other packages.
//
