...
func (catalog *ScopeCatalog) Register(ctx context.Context, scope corememory.Scope) error {
...
func (catalog *ScopeCatalog) List(ctx context.Context) ([]corememory.Scope, error) {
	if catalog == nil || nilInterface(catalog.kv) {
	...
	scopes := make([]corememory.Scope, 0, len(entries))
...
func catalogKey(scope corememory.Scope) (string, error) {
