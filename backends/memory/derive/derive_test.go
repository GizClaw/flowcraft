...
func TestRunOwnsSourceInputsAndOutputs(t *testing.T) {
	...
	source.Metadata = corememory.Metadata{"key": "original"}
	...
	returned[0].Content.Parts[0] = coremessage.TextPart{Text: "late mutation"}
	...
	cloned := result.Clone()
	cloned.Source.Content.Parts[0] = coremessage.TextPart{Text: "clone mutation"}
	cloned.Nodes[0].Artifacts[0].Content.Parts[0] = coremessage.TextPart{Text: "clone mutation"}
...
func artifact(id string) component.Artifact {
	return component.Artifact{
		Kind:    "source",
		ID:      id,
		Content: coremessage.Content{Parts: []coremessage.Part{coremessage.TextPart{Text: id}}},
		Sources: []corememory.SourceRef{{Kind: corememory.SourceDocument, ID: "document"}},
...
func derived(kind component.ArtifactKind, id string, input component.Artifact) component.Artifact {
	return component.Artifact{
		...
		Metadata: corememory.Metadata{"key": input.Metadata["key"]},
	}
}
