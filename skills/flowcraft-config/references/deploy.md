...
| `inference.Provider` | `openai`, `anthropic`, `bytedance`, `minimax`, `qwen` | core contract; `openai` serves the whole OpenAI wire family (OpenAI, Azure, DeepSeek, Kimi, gateways) through its endpoint/wire/catalog settings |
