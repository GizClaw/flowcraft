...
// BackendName is the sandbox config backend name for seatbelt.
...
// Register adds the seatbelt backend to a sandbox config builder. Its
	...
	return b.RegisterFactory(BackendName, func(
		...
		if err != nil {
			return nil, errdefs.Validationf(
				"decode seatbelt settings: %v", err)
		}
