...
func TestProviderWireRejectsNestedCanonicalRequestDTOs(t *testing.T) {
	...
	tests := []struct {
		...
		{"tools_intent", func() error { return bindLeakingGenerateWire[nested[ToolsIntent]]() }},
		{"sampling_intent", func() error { return bindLeakingGenerateWire[nested[SamplingIntent]]() }},
		{"reasoning_intent", func() error { return bindLeakingGenerateWire[nested[ReasoningIntent]]() }},
