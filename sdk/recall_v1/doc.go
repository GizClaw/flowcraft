...
// v0.5.0. New development should target sdk/recall, which is being
// rebuilt around TemporalFact, canonical stores, projections, planner,
// fusion, and evidence materialization.
//
// Capabilities:
//
