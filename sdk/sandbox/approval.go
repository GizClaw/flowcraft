...
// Enforcement forwards the inner runner's report: approval gates calls
// but does not itself enforce any policy dimension.
func (r *approvalRunner) Enforcement() Enforcement {
